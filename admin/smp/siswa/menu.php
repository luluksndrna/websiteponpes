<head>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="../../index_admin.php">DAARUSSYAHADAH NW MASBAGIK</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="sb-sidenav-menu">
                        ...
                        <div class="sb-sidenav-menu-heading">Siswa</div>
                         ...
                         <div class="sb-sidenav-menu-heading">Guru</div>
                                    ...
                                    <a class="nav-link collapsed" href="../guru/index.php">
                        ...
                        <div class="sb-sidenav-menu-heading">Pendaftaran</div>
                                    ...
                                    <a class="nav-link" href="../daftar/index.php">
