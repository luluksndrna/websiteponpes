                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        ...
                        <div class="sb-sidenav-menu-heading">Siswa</div>
                                ...
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div> SD IT</a>

                                <a class="nav-link " href="smp/siswa/index.php">
                                    <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div> SMP IT</a>

                                <a class="nav-link collapsed" href="sma/siswa/index.php">
                                    <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div> SMA</a>
                         ...
                         <div class="sb-sidenav-menu-heading">Guru</div>
                                    ...
                                    <a class="nav-link collapsed" href="sma/guru/index.php">
                                        <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div> SMA IT</a>

                        <div class="sb-sidenav-menu-heading">Pendaftaran</div>
                                     <a class="nav-link" href="sd/daftar/index.php">
                                            <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>SD IT</a>
                                    <a class="nav-link" href="smp/daftar/index.php">
                                            <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div> SMP IT</a>
                                    <a class="nav-link" href="sma/daftar/index.php">
                                            <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>SMA IT</a>
